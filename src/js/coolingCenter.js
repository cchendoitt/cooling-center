...
const coolingCenter = {
  ...
  DESCRIPTION_HTML: '<div class=panel_note><p>New York City opens cooling centers in air-conditioned public facilities for those experiencing physical discomfort in a heat wave.</p>'
    ...
    + '<a href="https://www1.nyc.gov/site/em/ready/extreme-heat.page">Learn more about ways to stay cool.</a></div>'
}
