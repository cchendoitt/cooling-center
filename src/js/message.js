nyc.oem.cc.TRANSLATION_LANGS = {
	en: {val: 'en', desc: 'English', hint: 'Translate'},
	ar: {val: 'ar', desc: 'Arabic / بالعربية', hint: 'بالعربية'},
	bn: {val: 'bn', desc: 'Bengali / বাংলা', hint: 'বাংলা'},
	zh: {val: 'zh', desc: 'Chinese / 繁體中文', hint: '繁體中文'},
	fr: {val: 'fr', desc: 'French / Francois', hint: 'Francois'},
	ht: {val: 'ht', desc: 'Haitian Creole / Kreyòl', hint: 'Kreyòl'},
	ko: {val: 'ko', desc: 'Korean / 한국어', hint: '한국어'},
	po: {val: 'po', desc: 'Polish / język polski', hint: 'język polski'},
	ru: {val: 'ru', desc: 'Russian / Русский', hint: 'Русский'},
	es: {val: 'es', desc: 'Spanish / Español', hint: 'Español'},
	ur: {val: 'ur', desc: 'Urdu / اردو', hint: 'اردو'}
};

nyc.oem.cc.messages = {};

nyc.oem.cc.messages.en = {
